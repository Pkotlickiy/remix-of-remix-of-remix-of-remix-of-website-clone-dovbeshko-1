...
export const metadata: Metadata = {
  title: "Контакты",
  description: "Контакты адвоката Довбешко С.Ю. в Санкт-Петербурге. Адрес офиса: Московский пр-кт. 216, Лит. А, офис 7. Телефон: +7 (931) 007-07-52. Email: S0070752@mail.ru",
  keywords: ["контакты адвоката", "адрес юриста спб", "телефон адвоката"],
  openGraph: {
    title: "Контакты | Адвокат Довбешко С.Ю.",
    description: "Адрес, телефон, email адвоката в Санкт-Петербурге. Московский пр-кт. 216, Лит. А, офис 7.",
